...
namespace PathCreation {
    ...
    public class VertexPath {
        ...
        public void GetPointAndRotationAtDistance(out Vector3 point, out Quaternion rotation, float distance, EndOfPathInstruction endOfPathInstruction = EndOfPathInstruction.Loop)
        {
            float t = distance / length;
            point = GetPointAtTime(t);
            rotation = GetRotation(t, endOfPathInstruction);
        }
